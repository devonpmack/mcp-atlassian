...
The section ends at the next same-or-higher heading, including a heading nested in a following excerpt, expand, or layout macro. That wrapper is left intact. Info panels and other macros are not boundaries. Lower-level sibling headings (an `h3` after an `h2`) are still part of the section.
</Warning>
